...
//   DateTime date;
//   String text;
//   DateTimePicker({Key? key, required this.date, required this.text}) : super(key: key);
//
//   @override
...
//       setState(() {
//         widget.date = picked;
//         if(widget.text == 'Date from')
//           DateRange.dateFrom = widget.date;
//         else
//           DateRange.dateTo = widget.date;
//         GetImports();
//       });
//   }
//
